...
public class PasswordManager {
    private readonly string _accoundsConnectionString;

    public PasswordManager(string dbPath) {
        _accoundsConnectionString = $"Data Source={dbPath}";
        InitializeDatabase();
    }

    public void InitializeDatabase() {
        using var connection = new SqliteConnection(_accoundsConnectionString);
        connection.Open();
